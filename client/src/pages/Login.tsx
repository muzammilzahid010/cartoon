      ...
      <Card className="w-full max-w-md shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-gray-700 rounded-lg border border-blue-200 dark:border-gray-600">
            ...
            <p className="text-xs text-blue-800 dark:text-blue-400">Username: <code className="bg-blue-100 dark:bg-gray-600 px-1 py-0.5 rounded">admin</code></p>
            <p className="text-xs text-blue-800 dark:text-blue-400">Password: <code className="bg-blue-100 dark:bg-gray-600 px-1 py-0.5 rounded">admin123</code></p>
          </div>
        </CardContent>
      </Card>
    </div>
