...
6. **View Videos (Step 5)**: Final display with video players and download options
   ...
   - **Merge All Videos**: Combine all completed videos into a single video file
     - FFmpeg-based concatenation with Cloudinary upload for permanent storage
     - Automatically saves merged video URL to the project
     - Merged video becomes viewable in the project detail page
...
- **Project Detail Page (`/projects/:id`)**: Full project view displaying:
  ...
  - **Merged Video**: If videos were merged, displays the complete story video
    - Video player with controls
    - Download button for merged video
