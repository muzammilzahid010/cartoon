...
- **Video Merging**: FFmpeg for concatenation, with Cloudinary upload for permanent storage and Google Drive API for user uploads.
...
- **Video Storage**: Google Drive API (OAuth 2.0) for merged video uploads, Cloudinary for individual video storage.
