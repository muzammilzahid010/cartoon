...
- **Home Page**: Tool selector dashboard with cards for each available tool: VEO 3.1 Video Generator, Bulk Video Generator, Text to Image Generator, Image to Video, Script Creator, and Video History.
...
- **Status Polling**: Video, image, and image-to-video status checks occur every 15 seconds (optimized from 2-3 seconds) to reduce server load and improve scalability for 100+ users.
